...
fetch API와 cache API로의 접근 덕분에 서비스 워커를 통해 웹사이트의 성능을 향상시킬 수도 있다. 
...
이때 '허용'을 누르면 브라우저에서 페이스북 페이지를 닫아도 브라우저로부터 "아무개가 회원님께 대화를 요청합니다"와 같은 메시지를 받을 수 있습니다. 
