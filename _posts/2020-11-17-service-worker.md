...
서비스 워커로 브라우저의 fetch API, cache API와 같은 저수준에서의 기능에 접근할 수 있습니다. 그리고, 이를 통해 개발자는 기존의 하지 못했던 강력한 오프라인 대응 기술을 확보하는 셈입니다.
...
예를 들어, 서버로부터 데이터를 수신 중 인터넷이 끊기거나 사용자가 브라우저를 닫더라도, 
서비스워커는 여전히 작동을 작동을 하기 때문에 이 기능이 가능합니다.
