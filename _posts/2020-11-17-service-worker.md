...
웹 세상에서는 사용자가 URL을 입력하면 우베 브라우저가 웹 서버에 요청을 보냅니다. 

그런데, 만약 <strong style="color: blue">웹 브라우저가 요청을 보내기도 전에 뭔가 작업하도록 지시할 수 있는 도구가 있다면 어떨까요? 서비스 워커는 바로 이것을 가능하게 해주는 도구</strong>입니다.
